...
class TourAdmin(admin.ModelAdmin):
    list_display = ("title", "destination", "category", "difficulty", "base_price", "currency", "duration_days", "rating", "max_capacity", "is_active", "is_latest", "created_at")
    list_filter = ("is_active", "is_latest", "destination", "category", "difficulty", "currency")
    search_fields = ("title", "slug", "description", "destination", "category")
    ...
    fieldsets = (
        ...
        ("Details", {"fields": ("destination", "duration_days", "max_capacity", "category", "difficulty", "rating", "badge")}),
