...
function FeaturedTourCard({
  ...
  return (
    <div className={noStagger ? "" : (staggerClasses[index % staggerClasses.length] || "")}>
      <div className="overflow-hidden rounded-[1.75rem] bg-[#171717] shadow-[0_24px_60px_-36px_rgba(0,0,0,0.55)]">
        ...
        <div className="flex items-center justify-between gap-3 border-t border-white/10 bg-[#101010] px-5 py-4">
          <Link
            href={`/tours/${tour.id}`}
            className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.22em] text-white/72 transition-colors duration-300 hover:text-white"
          >
            View Details
          ...
          <Link
            href={`/tours/${tour.id}`}
            className="inline-flex items-center gap-2 rounded-full bg-brand-red px-4 py-2 text-xs font-semibold text-white shadow-[0_18px_34px_-20px_rgba(226,19,1,0.95)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#c11000]"
          >
            Book Now
